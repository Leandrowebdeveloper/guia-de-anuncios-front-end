...
import { CategoryService } from '../../categoryAnnouncement/services/category.service';
...
@Component({
  ...
  styleUrls: [
    ...
    '../../../dashboard/user/administrator/users/management/management.page.scss',
  ],
})
export class ManagementPage implements OnInit {
  ...
  public state(category: Category): Subscription {
    ...
    return (this.write = this.categoryService.state(this.form.value).subscribe(
      (category_: Category) =>
        this.messageService.success(category_?.message, null, this.write, 350),
      (error: HttpErrorResponse) =>
