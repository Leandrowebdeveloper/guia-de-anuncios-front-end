...
export class FormComponent implements OnInit {
  ...
  private update(event: FormGroup): Subscription {
    const loading = this.categoryService.showLoading('Cadastrar categoria...');
  ...
  private restore(event: FormGroup): Subscription {
    const loading = this.categoryService.showLoading('Restaurar categoria...');
  ...
  private messsage(
    ...
    return this.categoryService.message(category, loading, this.write);
  }
